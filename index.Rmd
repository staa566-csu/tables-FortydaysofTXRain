...
To compare data from different years, I move these data manipulations into a function.
```{r}
...
```{r}
reactable_table <-  PD_allyears %>%group_by(State,year) %>% 
